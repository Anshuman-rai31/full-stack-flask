...
# app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:kausik%402931@localhost:3306/yo'

db_url = os.environ.get("DATABASE_URL", "mysql+mysqlconnector://root:kausik%402931@localhost:3306/yo")
